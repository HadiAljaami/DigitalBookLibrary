        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileSizeMb = table.Column<decimal>(type: "decimal(9,2)", precision: 9, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDownloadLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookDownloadLogs_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDownloadLogs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookReadLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookReadLogs_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookReadLogs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSavedBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedBooks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDownloadLogs_BookId",
                table: "BookDownloadLogs",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookDownloadLogs_UserId_DateDownloaded",
                table: "BookDownloadLogs",
                columns: new[] { "UserId", "DateDownloaded" });

            migrationBuilder.CreateIndex(
                name: "IX_BookReadLogs_BookId",
                table: "BookReadLogs",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookReadLogs_UserId_DateRead",
                table: "BookReadLogs",
                columns: new[] { "UserId", "DateRead" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedBooks_BookId",
                table: "UserSavedBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSavedBooks_UserId_BookId",
                table: "UserSavedBooks",
                columns: new[] { "UserId", "BookId" },
                unique: true);
        }
